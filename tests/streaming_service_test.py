...
class StreamingServiceTest(unittest.TestCase):
    ...
    def test_merge_stmt(self):
        ...
        merge_stmt = s._get_merge_query(dest_table="`staging.competitor_price2`", source_table="`pre_sync.competitor_price`", id_columns=id_columns, columns_update=columns_update, columns_insert=columns_insert)
        print(merge_stmt)